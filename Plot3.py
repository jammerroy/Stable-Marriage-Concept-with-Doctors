...
Algorithm=genfromtxt('plot_algo_eff_loss_with_100.dat')
Algorithm2=genfromtxt('plot_algo2_eff_loss_with_100.dat')
Random=genfromtxt('plot_random_eff_loss_with_100.dat')


Man_Random_nby2=genfromtxt('plot_manipulated_random_eff_loss_nby2_with_100.dat')
Man_Random_nby4=genfromtxt('plot_manipulated_random_eff_loss_nby4_with_100.dat')
Man_Random_nby8=genfromtxt('plot_manipulated_random_eff_loss_nby8_with_100.dat')
...
gp('set xrange [0:510]')
gp('set yrange [0:170000]')

gp('set xtics 100')
gp('set ytics 15000')

gp.plot(plot3,plot6,plot2,plot5,plot1,plot4)

epsFilename= 'Efficieny Loss_with_nby8_with_100.eps'
